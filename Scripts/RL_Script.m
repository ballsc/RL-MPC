...
trainStats_right = 
trainStats_straight =
trainStats_straight2 =

for i = 1:numel(keeps)
    trainingRight.(keeps{i}) = trainStats_right.(keeps{i});
    trainingStraight1.(keeps{i}) = trainStats_straight.(keeps{i});
    trainingStraight2.(keeps{i}) = trainStats_straight2.(keeps{i});
end