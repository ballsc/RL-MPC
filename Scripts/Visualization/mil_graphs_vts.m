...
%% TODO: add data from RL test 2

% Gather Data from output
data_mpc = load("Results\MPC_Best_Eval.mat");
data_rl1 = load("Results\MPC_RL_Best_Eval.mat");
...
% data from RL test 2
% lateral_jerk_rl2 = find(data_rl2, "lateralJerk").Values.Data;
...
plot(time,swAngleDeg_rl1, 'Color', '#642F6C', "DisplayName", "SAC+MPC", 'LineWidth',2)
hold on
plot(time,swAngleDeg_mpc, "r", "DisplayName","MPC", 'LineWidth',2)
% plot(time,swAngleDeg_10, "Color", "#00A3AD", "DisplayName","S_a_n_g = 10", 'LineWidth',2)
...
plot(time,lateral_jerk_rl1,'Color', '#642F6C', "DisplayName","SAC+MPC", 'LineWidth',2)
hold on
plot(time,lateral_jerk_mpc,"r", "DisplayName","MPC", 'LineWidth',2)
%plot(time,lateral_jerk_10,"Color", "#00A3AD", "DisplayName","S_a_n_g = 10", 'LineWidth',2)
...
% plot(time,offset_error_10,"Color", "#00A3AD", "DisplayName","S_a_n_g = 10", 'LineWidth',2)
